class StartGame extends egret.Sprite {
    ...
    private _resoucePrefix: string = 'start_';
    ...
    // 黄色液体
    private yellowTContainer: egret.Sprite;
        private yellowT: egret.Bitmap;
    
    // 按钮集
    private btnContainer: egret.Sprite;
        private btnBg: egret.Bitmap;
        private btnLine: egret.Bitmap;
    
        private btnStart: egret.Sprite;
            private BtnStart_Init: egret.Bitmap;
            private BtnStart_Over: egret.Bitmap;
        private btnRank: egret.Bitmap;
        private btnRule: egret.Bitmap;
    
    // 齿轮
    private gearContainer: egret.Sprite;
        private gear_1: egret.Bitmap;
        private gear_1S: egret.Bitmap;
        private gear_2: egret.Bitmap;
        private gear_2S: egret.Bitmap;
       
    private tipBg: egret.Shape;
    private tipContainer: egret.Sprite;
        private tipPhoneAnim: egret.Bitmap;
        private tipTxt: egret.Bitmap;
        private tipSkip: egret.Bitmap;
        
    private yellowTDelayShow: number;
    private yellowTAnimTimer: egret.Timer;
    private yellowId: number = 0;
    ...
    private addGreyT(): void {
        ...
        this.addChild( this.grayTContainer );
            ...
            this.grayT.x = 8; this.grayT.y = -130;
    ...
    private addMainTitle(): void {
        ...
        this.addChild( this.titleContainer );
            for( var i: number = 1; i <= 3; i++) {
                ...
                switch(i) {
                    case 1:
                        ...
                        this['titlePart_' + i].x = 234; this['titlePart_' + i].y = 248;
                        break;
                    case 2:
                        this['titlePart_' + i].anchorOffsetY = this['titlePart_' + i].height;
                        this['titlePart_' + i].x = 350; this['titlePart_' + i].y = 234;
                        break;
                    case 3:
                        this['titlePart_' + i].anchorOffsetX = this['titlePart_' + i].width;
                        this['titlePart_' + i].x = 126; this['titlePart_' + i].y = 266;
                        break;
                }
            }
            
            this.subTitle = new egret.Bitmap( RES.getRes( this._resoucePrefix + "subTitle" ) );
            this.subTitle.x = -554; this.subTitle.y = 394;
            ...
            this.mainTitle.x = 324; this.mainTitle.y = 220;
    ...
    private addRedT(): void {
        ...
        this.addChild( this.redTContainer );
            ...
            this.redT.x = 444; this.redT.y = 98;
            this.redT.alpha = 0;
    ...
    private addBtns(): void {
        ...
        this.addChild( this.btnContainer );
            ...
            this.btnBg.x = -170; this.btnBg.y = -148;
            this.btnBg.alpha = 0;
            ...
            this.btnRule.x = -218; this.btnRule.y = 64;
            ...
            this.btnRank.x = -218; this.btnRank.y = -52;
            ...
            egret.Tween.get( this.BtnStart_Over, { loop: true })
                .to( { alpha: 0 }, 1000 )
                .to( { alpha: 1 }, 1000 );
            ...
            function startOver( evt: egret.TouchEvent ): void {
                egret.Tween.removeTweens( this.BtnStart_Over );
                        
                this.BtnStart_Over.alpha = 1;
            }
            function startOut( evt: egret.TouchEvent ): void {
                egret.Tween.get( this.BtnStart_Over, { loop: true })
                    .to( { alpha: 0 }, 1000 )
                    .to( { alpha: 1 }, 1000 );
            }
            ...
            function ruleOver( evt: egret.TouchEvent ): void {
                evt.currentTarget.texture = RES.getRes( this._resoucePrefix + "btnRule_Over" );
            }
            function ruleOut( evt: egret.TouchEvent ): void {
    ...
    private showTip( evt: egret.TouchEvent ): void {
        this.pauseAnim();
    ...
    private createTip(): void {
        ...
        this.addChild( this.tipContainer );
            ...
            egret.Tween.get( this.tipPhoneAnim, { loop: true })
                .to( { rotation: -16 }, 1000 )
                .to( { rotation: 16 }, 1000 );
            ...
            function onSkipToGame( evt: egret.TouchEvent ): void {
                this.dispatchEvent( new egret.Event( 'skipToGame', true ) );
            }
    }

    private addYellowT(): void {
        ...
        this.addChild( this.yellowTContainer );
            ...
            this.yellowT.x = 198; this.yellowT.y = 416;
    ...
    private addGears(): void {
        ...
        this.addChild( this.gearContainer );
            ...
            this.gear_1S.x = 52; this.gear_1S.y = 8;
            ...
            this.gear_2S.x = 594; this.gear_2S.y = -2;            
            ...
            this.gear_1.x = 56; this.gear_1.y = -16;            
            ...
            this.gear_2.x = 588; this.gear_2.y = -16;            
            this.gearContainer.addChild( this.gear_2 );
            
            egret.Tween.get( this.gear_1S, { loop: true })
                .to( { rotation: 360 }, 8000 );
                        
            egret.Tween.get( this.gear_2S, { loop: true })
                .to( { rotation: -360 }, 8000 );
                        
            egret.Tween.get( this.gear_1, { loop: true })
                .to( { rotation: 360 }, 8000 );
                            
            egret.Tween.get( this.gear_2, { loop: true })
                .to( { rotation: -360 }, 8000 );
    }
    ...
    private introAnim(): void {
        ...
        egret.Tween.get( this.titlePart_1 )
            .wait( 200 )
            .to( { x: 200, y: 134 }, 250, egret.Ease.backOut );
        egret.Tween.get( this.titlePart_2 )
            .wait( 200 )
            .to( { x: 348, y: 106 }, 250, egret.Ease.backOut );
        egret.Tween.get( this.titlePart_3 )
            .wait( 200 )
            .to( { x: 126, y: 350 }, 250, egret.Ease.backOut );
        egret.Tween.get( this.grayT )
            .wait( 400 )
            .to( {y: 52}, 250, egret.Ease.backOut );
        egret.Tween.get( this.subTitle )
            .wait( 450 )
            .to( {x: 42,y: 324}, 250, egret.Ease.backOut );
        egret.Tween.get( this.redT )
            .wait( 700 )
            .to( { scaleX: 1, scaleY: 1, x: 512, y: 186, alpha: 1 }, 750, egret.Ease.elasticOut );
            
        egret.Tween.get( this.gearContainer )
            .wait( 900 )
            .to( { y: this._iH }, 400, egret.Ease.backOut );
            
        egret.Tween.get( this.btnStart )
            .wait( 1200 )
            .to( { y: -206, alpha: 1 }, 350, egret.Ease.backOut );
        egret.Tween.get( this.btnRank )
            .wait( 1300 )
            .to( { y: -92, alpha: 1 }, 350, egret.Ease.backOut );
        egret.Tween.get( this.btnRule )
            .wait( 1400 )
            .to( { y: 24, alpha: 1 }, 350, egret.Ease.backOut );
        egret.Tween.get( this.btnBg )
            .wait( 1800 )
            .to( { alpha: 1 }, 350 );
        egret.Tween.get( this.btnLine )
            .wait( 1900 )
            .to( { alpha: 1 }, 350 );
            
        this.yellowTDelayShow = egret.setTimeout(this.showYellowAnim, this, 1500);
    }
    private showYellowAnim(): void {
    ...
    private goYellowAnim( evt: egret.TimerEvent ): void {
        this.yellowId++;
        this.yellowT.texture = RES.getRes( this._resoucePrefix + "yellowT" + this.yellowId );
    } 
        
    private pauseAnim( evt: egret.Event = null ): void {
    ...
    private resumeAnim( evt: egret.Event = null ): void {
