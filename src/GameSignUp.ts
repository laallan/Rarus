class GameSignUp extends egret.DisplayObjectContainer {
    private _iW: number;
    private _iH: number;
    private _scaleRate: number;
            
    private _resoucePrefix: string = 'signup_';
    
    private alphaBlack: egret.Shape;
    
    private topTitleContainer: egret.DisplayObjectContainer;
        private topTitle: egret.Bitmap;
    
    private formContainer: egret.DisplayObjectContainer;
        private formBg: egret.Bitmap;
        private nameText: egret.TextField;
        private companyNameText: egret.TextField;
        
        private companyTypeText: egret.TextField;
            private companyTypeBtn: egret.Shape;
            private companyTypeSelectCT: egret.DisplayObjectContainer;
                private companyTypeSelectBg: egret.Shape;
                private companyTypeArray: any[] = ['设备制造商', '设备用户', '贸易商', '设备维护/服务公司', '其他'];
        private companyTypeAreaText: egret.TextField;
            private companyTypeAreaBtn: egret.Shape;
            private companyTypeAreaCT: egret.DisplayObjectContainer;
                private companyTypeAreaBg: egret.Shape;
                private companyTypeAreaArray: any[] = ['风电行业', '电力行业', '矿山行业', '油气勘探开发', '机加工行业', '工程机械行业', '钢铁行业', '水泥行业', '造纸行业', '塑料行业', '食品行业', '其他'];
        
        private emailText: egret.TextField;
        private phoneText: egret.TextField;
        private allowPoint: egret.Bitmap;
        private allowInfoText: egret.TextField;
        private allowPointBtn_1: egret.Shape;
        private allowPointBtn_2: egret.Shape;
        
    private btnContainer: egret.Sprite;
        private backBtn: egret.Bitmap;
        private signBtn: egret.Bitmap;
        private signInfo: egret.TextField;
    ...
    private compArea: string = '';
    private userEmail: string = '';
    public userPhone: string = '';
    private allowEmail: string = '1';
    public userScore: string = '';
    
    private sendScoreUrl: string = 'ajax.php?flg=1';
    private sendInfoLoader: egret.URLLoader;
    private sendInfoRequest: egret.URLRequest;
    private sendInfoVariables: egret.URLVariables;
    ...
    private addBtns(): void {
        ...
        this.addChild( this.btnContainer );
            ...
            this.backBtn.x = 12; this.backBtn.y = -190;
            ...
            function onBackOver( evt: egret.TouchEvent ): void {
                evt.currentTarget.texture = RES.getRes( this._resoucePrefix + 'back_Over' );
            }
            function onBackOut( evt: egret.TouchEvent ): void {
            ...
            this.signBtn.x = 302; this.signBtn.y = -168;
            ...
            this.signInfo.x = 90; this.signInfo.y = -62;
            this.btnContainer.addChild( this.signInfo );
    }    

    private onBackTap( evt: egret.TouchEvent ): void {
        this.dispatchEvent( new egret.Event( 'backToSuccess', true ) );
    }
    private onSignTap( evt: egret.TouchEvent ): void {
        if ( this.nameText.text == '' ) {
            alert( '请输入你的姓名' );
            this.signBtn.touchEnabled = false;

            egret.setTimeout( function(){this.signBtn.touchEnabled = true;}, this, 1000 );
    ...
    private addFormObjects(): void {
        ...
        this.formContainer.y = this._iH * .5;
            ...
            this.allowInfoText.x = 62; this.allowInfoText.y = 580;
            ...
            this.nameText.width = 270; this.nameText.height = 48;
            this.nameText.x = 250; this.nameText.y = 46;
            ...
            this.companyNameText.width = 270; this.companyNameText.height = 48;
            this.companyNameText.x = 250; this.companyNameText.y = 128;
            ...
            this.companyTypeText.x = 250; this.companyTypeText.y = 210;
            ...
            this.companyTypeAreaText.x = 250; this.companyTypeAreaText.y = 292;
            ...
            this.emailText.width = 270; this.emailText.height = 48;
            this.emailText.x = 250; this.emailText.y = 374;
            ...
            this.phoneText.width = 270; this.phoneText.height = 48;
            this.phoneText.x = 250; this.phoneText.y = 456;
            this.formContainer.addChild( this.phoneText );
            
            this.allowPoint = new egret.Bitmap( RES.getRes( this._resoucePrefix + 'point' ) );
            this.allowPoint.x = 34; this.allowPoint.y = 582;
            ...
            this.formContainer.addChild( this.companyTypeSelectCT );
                ...
                for( var i: number = 1; i <= 5; i++ ) {
                    var companyType_perBg: egret.Shape = new egret.Shape();
                    ...
                    var companyType_perText: egret.TextField = new egret.TextField();
                ...
                function onTypeBtnOver( evt: egret.TouchEvent ): void {
                ...
                function onTypeBtnOut( evt: egret.TouchEvent ): void {
            ...
            this.formContainer.addChild( this.companyTypeAreaCT );
                ...
                for( var i: number = 1; i <= 12; i++ ) {
                    var companyArea_perBg: egret.Shape = new egret.Shape();
                    ...
                    var companyArea_perText: egret.TextField = new egret.TextField();
                ...
                function onAreaBtnOver( evt: egret.TouchEvent ): void {
                    evt.currentTarget.graphics.beginFill( 0x333333 );
                    evt.currentTarget.graphics.drawRect( 0, 0, 640, 70 );
                    evt.currentTarget.graphics.endFill();
                }
                function onAreaBtnOut( evt: egret.TouchEvent ): void {
                    evt.currentTarget.graphics.beginFill( 0x0A0A0A );
                    evt.currentTarget.graphics.drawRect( 0, 0, 640, 70 );
                    evt.currentTarget.graphics.endFill();
                }
    ...
    // 所有按钮事件
    private selectCompTypeTap( evt: egret.TouchEvent ): void {
        this.companyTypeSelectCT.visible = true;
    }
    private selectCompTypeAreaTap( evt: egret.TouchEvent ): void {
        this.companyTypeAreaCT.visible = true;
    }
    
    private changeAllow( evt: egret.TouchEvent ): void {
        if ( evt.currentTarget.name == 'allowTrue' ) {
            if( this.allowEmail == '0' ) this.allowEmail = '1';
            this.allowPoint.y = 582;
        } else {
            if ( this.allowEmail == '1' ) this.allowEmail = '0';
            this.allowPoint.y = 616;
        }
    }
    
    private onTypeTap( evt: egret.TouchEvent ): void {
        var nid: number = Number( evt.currentTarget.name.substr( 9, evt.currentTarget.name.length - 9 ) ) - 1;
        this.companyTypeText.text = this.companyTypeArray[ nid ];
        this.companyTypeSelectCT.visible = false;
    }
    private onAreaTap( evt: egret.TouchEvent ): void {
        var nid: number = Number( evt.currentTarget.name.substr( 9, evt.currentTarget.name.length - 9 ) ) - 1;
