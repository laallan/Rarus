class GameRule extends egret.Sprite {
    private _iW: number;
    private _iH: number;
    private _scaleRate: number;
        
    private _resoucePrefix: string = 'rule_';
    
    private alphaBlack: egret.Shape;
    
    private ruleCT: egret.Sprite;

    private ruleTxt: egret.Bitmap;
    private ruleBg: egret.Bitmap;
    private ruleClose: egret.Bitmap;
    
    private ruleBan: egret.Bitmap;
    private ruleBanMask: egret.Shape;
    
    private txtScroll: egret.ScrollView;
    
    private static banTop: number = 98;
    private static banBottom: number = 606;
	...
	private addRule(): void {
        ...
        this.ruleCT.x = this._scaleRate * 64; this.ruleCT.y = this._iH;
        ...
        this.addChild( this.ruleCT );
            ...
            this.ruleClose.x = 508; this.ruleClose.y = 2;
    ...
    private onEnterFrameTop( evt: egret.Event ): void {
    ...
    private onClose( evt: egret.TouchEvent ): void {
        egret.Tween.get( this.ruleCT )
            .to( { y: this._iH }, 350, egret.Ease.cubicInOut )
            .call( function() { this.dispatchEvent( new egret.Event( 'hideRule', true ) ); }, this );
    }
	
    private introAnim(): void {
        egret.Tween.get( this.ruleCT )
            .to( { y: ( this._iH - this._scaleRate * this.ruleBg.height ) * .5 }, 350, egret.Ease.cubicInOut );
    }
