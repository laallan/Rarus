var Gameing = (function (_super) {
    ...
    p.restartGame = function (evt) {
        ClickEvent('SHCrarus', 'SHCrarus/rarus_Play_play_again_Click', 'Click');
        if (evt === void 0) { evt = null; }
        egret.Tween.removeTweens(this.timeBarHaveTime);
    ...
    p.pauseGame = function (evt) {
        ClickEvent('SHCrarus', 'SHCrarus/rarus_Play_game_rules_Click', 'Click');
        if (evt === void 0) { evt = null; }
        this.checkTimer.stop();
    ...
    p.finishGame = function (evt) {
        ClickEvent('SHCrarus', 'SHCrarus/rarus_Play_give_up_Click', 'Click');
        if (evt === void 0) { evt = null; }
        this.checkTimer.stop();
        this.mainGameScreen.stopGame();
