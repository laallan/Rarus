var PerRank = (function (_super) {
    __extends(PerRank, _super);
    function PerRank(id, nm, sc, sf) {
        _super.call(this);
    ...
    var d = __define,c=PerRank;p=c.prototype;
    p.onAddToStage = function (evt) {
        ...
        if (this._id <= 10) {
            ...
            this.timeIcon.width = 32;
            this.timeIcon.height = 32;
            this.timeIcon.x = 374;
            this.timeIcon.y = 18;
...
egret.registerClass(PerRank,"PerRank");
