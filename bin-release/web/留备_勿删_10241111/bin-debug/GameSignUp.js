var GameSignUp = (function (_super) {
    ...
    p.onBackTap = function (evt) {
        ClickEvent('SHCrarus', 'SHCrarus/rarus_Mi_return_Click', 'Click');
        this.dispatchEvent(new egret.Event('backToSuccess', true));
    };
    p.onSignTap = function (evt) {
        ClickEvent('SHCrarus', 'SHCrarus/rarus_Mi_register_now_Click', 'Click');
    ...
    p.selectCompTypeTap = function (evt) {
        ClickEvent('SHCrarus', 'rarus_Mi_property_company_Click', 'Click');
        this.companyTypeSelectCT.visible = true;
    };
    p.selectCompTypeAreaTap = function (evt) {
        ClickEvent('SHCrarus', 'SHCrarus/rarus_Mi_property_profession_Click', 'Click');
