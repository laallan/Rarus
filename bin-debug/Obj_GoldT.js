var Obj_GoldT = (function (_super) {
    __extends(Obj_GoldT, _super);
    function Obj_GoldT(rate) {
        _super.call(this);
    ...
    var d = __define,c=Obj_GoldT;p=c.prototype;
    p.onAddToStage = function (evt) {
        this.backNoAnim = new egret.Bitmap(RES.getRes(this._resoucePrefix + "objGoldT"));
        this.addChild(this.backNoAnim);
        this.topAnim = new egret.Bitmap(RES.getRes(this._resoucePrefix + "objGoldT2"));
...
egret.registerClass(Obj_GoldT,"Obj_GoldT");
