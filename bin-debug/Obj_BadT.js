var Obj_BadT = (function (_super) {
    __extends(Obj_BadT, _super);
    function Obj_BadT(rate) {
        _super.call(this);
    ...
    var d = __define,c=Obj_BadT;p=c.prototype;
    p.onAddToStage = function (evt) {
        this.backNoAnim = new egret.Bitmap(RES.getRes(this._resoucePrefix + "objBadT"));
        this.addChild(this.backNoAnim);
        this.topAnim = new egret.Bitmap(RES.getRes(this._resoucePrefix + "objBadT2"));
...
egret.registerClass(Obj_BadT,"Obj_BadT");
