var Obj_RedT = (function (_super) {
    __extends(Obj_RedT, _super);
    function Obj_RedT(rate) {
        _super.call(this);
    ...
    var d = __define,c=Obj_RedT;p=c.prototype;
...
egret.registerClass(Obj_RedT,"Obj_RedT");
